...
MERGE INTO users (username, email, password, avatar_url, display_name, bio, provider) KEY (username) VALUES
('admin', 'admin@synapse.dev', '$2a$10$A3bHkjAoE91EYKaeSymzCeA/GH2SCFBYOzXtzmaOU52VVFWQjkdSK', 'https://api.dicebear.com/7.x/notionists/svg?seed=Admin', '管理员', '全栈开发者，热爱开源。专注于 Java 和 React 技术栈。', 'LOCAL');

MERGE INTO users (username, email, password, avatar_url, display_name, bio, provider) KEY (username) VALUES
('alice', 'alice@synapse.dev', '$2a$10$YVFOLZCffY8Q5zqFbq.KU.y5himz4d7NjOpglx2pI9ZlglID/a50.', 'https://api.dicebear.com/7.x/notionists/svg?seed=Alice', '爱丽丝', 'Python 爱好者，数据科学工程师。喜欢分享编程技巧和最佳实践。', 'LOCAL');

MERGE INTO users (username, email, password, avatar_url, display_name, bio, provider) KEY (username) VALUES
('bob', 'bob@synapse.dev', '$2a$10$kU7/rB7MRf5Wpg5Fv9NFZO3AlkQ.kD8fMd5mWsVcbRHwNyAkiDt1i', 'https://api.dicebear.com/7.x/notionists/svg?seed=Bob', '鲍勃', '前端开发者，React 和 TypeScript 粉丝。致力于构建优雅的用户界面。', 'LOCAL');

MERGE INTO users (username, email, password, avatar_url, display_name, bio, provider) KEY (username) VALUES
('charlie', 'charlie@synapse.dev', '$2a$10$vElQynQ3WrgQ9jYGOokNMO9C94/FWxSJBdoSYWBSTXuerLdJsogKe', 'https://api.dicebear.com/7.x/notionists/svg?seed=Charlie', '查理', '后端架构师，专注微服务和分布式系统。Spring Boot 布道师。', 'LOCAL');
