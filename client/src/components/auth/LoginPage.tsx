...
export function LoginPage() {
	const { login, register, loginWithGitHub, loginWithGoogle, isLoggingIn, isRegistering } = useAuth();
		...
		<div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 px-4 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
			<Card className="w-full max-w-md shadow-xl">
				<CardHeader className="text-center">
					...
					<CardDescription>Connect, share, and discover knowledge</CardDescription>
				</CardHeader>
				<CardContent>
					<Tabs defaultValue="login" className="w-full">
						...
						<TabsContent value="login" className="mt-6">
							<LoginForm
								...
								onOAuthLogin={{ github: loginWithGitHub, google: loginWithGoogle }}
